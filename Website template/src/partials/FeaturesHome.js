          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                <h3 className="h3 mb-3">Erinevad materialid</h3>
                <p className="text-xl text-gray-600">Siin on mingi sissejuhatav näidistekst. Mingi 2 kuni 3 lause pikk jutt näiteks. Siia panin siis mõned suvalised "materjalid" :).</p>
              </div>
              {/* Tabs buttons */}
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Puit</div>
              ...
              <div className="relative flex flex-col text-center lg:text-right">
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img className="md:max-w-none mx-auto rounded" src={require('../images/wood-types.gif').default} width="500" height="375" alt="Features bg" />
                  </div>
                </Transition>
                {/* Item 2 */}
                <Transition
